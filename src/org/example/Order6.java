...
public class Order6 extends JFrame implements ActionListener, MouseListener {
	...
	public Order6() {
		...
		// Names
		l8  = new JLabel("Tea"); l8.setBounds(90,510,500,40);
		l9  = new JLabel("Coffee Milkshake"); l9.setBounds(260,510,500,40);
		l10 = new JLabel("Kombucha"); l10.setBounds(520,510,500,40);
		l11 = new JLabel("Ginger Beer"); l11.setBounds(730,510,500,40);
		l12 = new JLabel("Punch"); l12.setBounds(970,510,500,40);
		l13 = new JLabel("Lemonade"); l13.setBounds(1180,510,500,40);
		...
		// Buttons
		b1 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("tea (1).jpg"))));
		b1.setBounds(30,200,200,300); b1.setCursor(c1); b1.addActionListener(this); p1.add(b1);

		b2 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("coffee (1).jpg"))));
		b2.setBounds(250,200,200,300); b2.setCursor(c1); b2.addActionListener(this); p1.add(b2);

		b3 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("kombucha (1).jpg"))));
		b3.setBounds(470,200,200,300); b3.setCursor(c1); b3.addActionListener(this); p1.add(b3);

		b4 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("ginger beer (1).jpg"))));
		b4.setBounds(690,200,200,300); b4.setCursor(c1); b4.addActionListener(this); p1.add(b4);

		b5 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("punch (1).jpg"))));
		b5.setBounds(910,200,200,300); b5.setCursor(c1); b5.addActionListener(this); p1.add(b5);

		b6 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("lemonade (1).jpg"))));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b1){ Cart.addItem("Tea",100); JOptionPane.showMessageDialog(this,"Added Tea"); }
		if(e.getSource()==b2){ Cart.addItem("Coffee Milkshake",100); JOptionPane.showMessageDialog(this,"Added Coffee Milkshake"); }
		if(e.getSource()==b3){ Cart.addItem("Kombucha",100); JOptionPane.showMessageDialog(this,"Added Kombucha"); }
		if(e.getSource()==b4){ Cart.addItem("Ginger Beer",100); JOptionPane.showMessageDialog(this,"Added Ginger Beer"); }
		if(e.getSource()==b5){ Cart.addItem("Punch",100); JOptionPane.showMessageDialog(this,"Added Punch"); }
		if(e.getSource()==b6){ Cart.addItem("Lemonade",100); JOptionPane.showMessageDialog(this,"Added Lemonade"); }
