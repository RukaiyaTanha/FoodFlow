...
public class Order4 extends JFrame implements ActionListener, MouseListener {
	...
	public Order4() {
		...
		l3 = new JLabel("What type Salad would you like to order?");
		...
		// Names
		l8  = new JLabel("Green Salad");      l8.setBounds(50,510,500,40);
		l9  = new JLabel("Salmon Salad");     l9.setBounds(280,510,500,40);
		l10 = new JLabel("Pasta Salad");      l10.setBounds(510,510,500,40);
		l11 = new JLabel("Seafood Salad");    l11.setBounds(720,510,500,40);
		l12 = new JLabel("Vegetable Salad");  l12.setBounds(930,510,500,40);
		l13 = new JLabel("Potato Salad");     l13.setBounds(1170,510,500,40);
		...
		// Food buttons
		b1 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("grren salad (1).jpg"))));
		b1.setBounds(30,200,200,300); b1.setCursor(c1); b1.addActionListener(this); p1.add(b1);

		b2 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("salmon salad (1).jpg"))));
		b2.setBounds(250,200,200,300); b2.setCursor(c1); b2.addActionListener(this); p1.add(b2);

		b3 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("pasata salad (1).jpg"))));
		b3.setBounds(470,200,200,300); b3.setCursor(c1); b3.addActionListener(this); p1.add(b3);

		b4 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("seafood salad (1).jpg"))));
		b4.setBounds(690,200,200,300); b4.setCursor(c1); b4.addActionListener(this); p1.add(b4);

		b5 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("vegetable salad (1).jpg"))));
		b5.setBounds(910,200,200,300); b5.setCursor(c1); b5.addActionListener(this); p1.add(b5);

		b6 = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("potato salad (1).jpg"))));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b1){ Cart.addItem("Green Salad",100); JOptionPane.showMessageDialog(this,"Added Green Salad"); }
		if(e.getSource()==b2){ Cart.addItem("Salmon Salad",100); JOptionPane.showMessageDialog(this,"Added Salmon Salad"); }
		if(e.getSource()==b3){ Cart.addItem("Pasta Salad",100); JOptionPane.showMessageDialog(this,"Added Pasta Salad"); }
		if(e.getSource()==b4){ Cart.addItem("Seafood Salad",100); JOptionPane.showMessageDialog(this,"Added Seafood Salad"); }
		if(e.getSource()==b5){ Cart.addItem("Vegetable Salad",100); JOptionPane.showMessageDialog(this,"Added Vegetable Salad"); }
		if(e.getSource()==b6){ Cart.addItem("Potato Salad",100); JOptionPane.showMessageDialog(this,"Added Potato Salad"); }
